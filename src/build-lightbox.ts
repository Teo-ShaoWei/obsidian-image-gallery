...
import AutoplayPlugin from "lightgallery/plugins/autoplay";
import ThumbnailPlugin from "lightgallery/plugins/thumbnail";
...
const lightbox = (
  ...
  const galleryLightbox = Lightbox(gallery, {
    plugins: [AutoplayPlugin, ThumbnailPlugin],
